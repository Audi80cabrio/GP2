...
template <> constexpr inline auto MainWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'updateWindow'
        QtMocHelpers::SlotData<void(std::vector<float>)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
    };
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->startUfo(); break;
        case 2: _t->updateWindow((*reinterpret_cast< std::add_pointer_t<std::vector<float>>>(_a[1]))); break;
        default: ;
        }
    }
}
